...
export const V6_SLICE1_TECHNIQUES: TechniqueCardDef[] = [
  ...
  {
    kind: 'technique',
    id: 'v6-technik-fintenschnitt',
    name: 'Fintenschnitt',
    stability: 2,
    activationMode: 'instant',
    effectText: 'Defensive Finte: bereitet den nächsten Block vor.',
  },
  {
    kind: 'technique',
    id: 'v6-technik-brechschlag',
    name: 'Brechschlag',
    stability: 3,
    activationMode: 'instant',
    effectText: 'Durchschlagender Formelschaden gegen den Gegner.',
  },
  {
    kind: 'technique',
    id: 'v6-technik-kettenfessel',
    name: 'Kettenfessel',
    stability: 3,
    activationMode: 'instant',
    effectText: 'Fesselt eine gegnerische Formelkomponente (manuelle Zielwahl).',
  },
  {
    kind: 'technique',
    id: 'v6-technik-bannkreis',
    name: 'Bannkreis',
    stability: 4,
    activationMode: 'instant',
    effectText: 'Schützender Kreis — Schild und defensive Formelwirkung.',
  },
  {
    kind: 'technique',
    id: 'v6-technik-ueberraschungsangriff',
    name: 'Überraschungsangriff',
    stability: 3,
    activationMode: 'instant',
    effectText: 'Überraschender Formelschaden; offensiv und druckvoll.',
  },
  {
    kind: 'technique',
    id: 'v6-technik-schicksalmanifestation',
    name: 'Schicksalmanifestation',
    stability: 2,
    activationMode: 'instant',
    effectText: 'Schicksalstempo: bereitet den nächsten Boost vor.',
  },
  {
    kind: 'technique',
  ...
  {
    kind: 'technique',
    id: 'v6-technik-beschwoerungsritual',
    name: 'Beschwörungsritual',
    stability: 3,
    activationMode: 'instant',
    effectText:
      'Beschwört ein Konstrukt (Haltbarkeit). Max 1; ersetzt bestehendes. Keine Fetzladung.',
  },
];
