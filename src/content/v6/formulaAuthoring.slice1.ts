 ...
 *
 * Catalog: 10 Techniken × 6 Essenzen × 10 Katalysatoren → generated recipes (#383).
 * 4 catalysts stay `unsupported` (explicit recipes, no invented effects §50.3).
...
const TK_NAMES: Record<TechId, Record<MatrixCatId, string>> = {
  'v6-technik-impulsgeschoss': {
    ...
    'v6-katalysator-ausbreitung': 'Spreadimpuls',
    'v6-katalysator-kettenkopplung': 'Kettenimpuls',
    'v6-katalysator-verzoegerung': 'Delayimpuls',
    'v6-katalysator-sofortzuender': 'Zündimpuls',
    'v6-katalysator-spiegelung': 'Spiegelimpuls',
    'v6-katalysator-umkehrung': 'Kehrimpuls',
  ...
  'v6-technik-adrenalinschrei': {
    ...
    'v6-katalysator-ausbreitung': 'Spreadschrei',
    'v6-katalysator-kettenkopplung': 'Kettenschrei',
    'v6-katalysator-verzoegerung': 'Delayschrei',
    'v6-katalysator-sofortzuender': 'Zündschrei',
    'v6-katalysator-spiegelung': 'Spiegelschrei',
    'v6-katalysator-umkehrung': 'Kehrschrei',
  ...
  'v6-technik-fintenschnitt': {
    ...
    'v6-katalysator-ausbreitung': 'Spreadfinte',
    'v6-katalysator-kettenkopplung': 'Kettenfinte',
    'v6-katalysator-verzoegerung': 'Delayfinte',
    'v6-katalysator-sofortzuender': 'Zündfinte',
    'v6-katalysator-spiegelung': 'Spiegelfinte',
    'v6-katalysator-umkehrung': 'Kehrfinte',
  ...
  'v6-technik-brechschlag': {
    ...
    'v6-katalysator-ausbreitung': 'Spreadbruch',
    'v6-katalysator-kettenkopplung': 'Kettenbruch',
    'v6-katalysator-verzoegerung': 'Delaybruch',
    'v6-katalysator-sofortzuender': 'Zündbruch',
    'v6-katalysator-spiegelung': 'Spiegelbruch',
    'v6-katalysator-umkehrung': 'Kehrbruch',
  ...
  'v6-technik-kettenfessel': {
    ...
    'v6-katalysator-ausbreitung': 'Spreadkette',
    'v6-katalysator-kettenkopplung': 'Kopplungskette',
    'v6-katalysator-verzoegerung': 'Delaykette',
    'v6-katalysator-sofortzuender': 'Zündkette',
    'v6-katalysator-spiegelung': 'Spiegelkette',
    'v6-katalysator-umkehrung': 'Kehrkette',
  ...
  'v6-technik-bannkreis': {
    ...
    'v6-katalysator-ausbreitung': 'Spreadkreis',
    'v6-katalysator-kettenkopplung': 'Kettenkreis',
    'v6-katalysator-verzoegerung': 'Delaykreis',
    'v6-katalysator-sofortzuender': 'Zündkreis',
    'v6-katalysator-spiegelung': 'Spiegelkreis',
    'v6-katalysator-umkehrung': 'Kehrkreis',
  ...
  'v6-technik-ueberraschungsangriff': {
    ...
    'v6-katalysator-ausbreitung': 'Spreadstoß',
    'v6-katalysator-kettenkopplung': 'Kettenstoß',
    'v6-katalysator-verzoegerung': 'Delaystoß',
    'v6-katalysator-sofortzuender': 'Zündstoß',
    'v6-katalysator-spiegelung': 'Spiegelstoß',
    'v6-katalysator-umkehrung': 'Kehrstoß',
  ...
  'v6-technik-schicksalmanifestation': {
    ...
    'v6-katalysator-ausbreitung': 'Spreadschicksal',
    'v6-katalysator-kettenkopplung': 'Kettenschicksal',
    'v6-katalysator-verzoegerung': 'Delayschicksal',
    'v6-katalysator-sofortzuender': 'Zündschicksal',
    'v6-katalysator-spiegelung': 'Spiegelschicksal',
    'v6-katalysator-umkehrung': 'Kehrschicksal',
  ...
  'v6-technik-magiepanzer': {
    ...
    'v6-katalysator-ausbreitung': 'Spreadpanzer',
    'v6-katalysator-kettenkopplung': 'Kettenpanzer',
    'v6-katalysator-verzoegerung': 'Delaypanzer',
    'v6-katalysator-sofortzuender': 'Zündpanzer',
    'v6-katalysator-spiegelung': 'Spiegelpanzer',
    'v6-katalysator-umkehrung': 'Kehrpanzer',
  ...
  'v6-technik-beschwoerungsritual': {
    ...
    'v6-katalysator-ausbreitung': 'Spreadritual',
    'v6-katalysator-kettenkopplung': 'Kettenritual',
    'v6-katalysator-verzoegerung': 'Delayritual',
    'v6-katalysator-sofortzuender': 'Zündritual',
    'v6-katalysator-spiegelung': 'Spiegelritual',
    'v6-katalysator-umkehrung': 'Kehrritual',
...
const EK_NAMES: Record<EssId, Record<MatrixCatId, string>> = {
  'v6-essenz-feuer': {
    ...
    'v6-katalysator-ausbreitung': 'Glutspread',
    'v6-katalysator-kettenkopplung': 'Glutkette',
    'v6-katalysator-verzoegerung': 'Glutverzögerung',
    'v6-katalysator-sofortzuender': 'Funkenzünder',
    'v6-katalysator-spiegelung': 'Glutspiegel',
    'v6-katalysator-umkehrung': 'Glutkehre',
  ...
  'v6-essenz-wasser': {
    ...
    'v6-katalysator-ausbreitung': 'Wellenspread',
    'v6-katalysator-kettenkopplung': 'Wellenkette',
    'v6-katalysator-verzoegerung': 'Wellenverzögerung',
    'v6-katalysator-sofortzuender': 'Spritzzünder',
    'v6-katalysator-spiegelung': 'Wellenspiegel',
    'v6-katalysator-umkehrung': 'Wellenkehre',
  ...
  'v6-essenz-erde': {
    ...
    'v6-katalysator-ausbreitung': 'Felsspread',
    'v6-katalysator-kettenkopplung': 'Felskette',
    'v6-katalysator-verzoegerung': 'Felsverzögerung',
    'v6-katalysator-sofortzuender': 'Felszünder',
    'v6-katalysator-spiegelung': 'Felsspiegel',
    'v6-katalysator-umkehrung': 'Felskehre',
  ...
  'v6-essenz-luft': {
    ...
    'v6-katalysator-ausbreitung': 'Windspread',
    'v6-katalysator-kettenkopplung': 'Windkette',
    'v6-katalysator-verzoegerung': 'Windverzögerung',
    'v6-katalysator-sofortzuender': 'Windzünder',
    'v6-katalysator-spiegelung': 'Windspiegel',
    'v6-katalysator-umkehrung': 'Windkehre',
  ...
  'v6-essenz-licht': {
    ...
    'v6-katalysator-ausbreitung': 'Lichtspread',
    'v6-katalysator-kettenkopplung': 'Lichtkette',
    'v6-katalysator-verzoegerung': 'Lichtverzögerung',
    'v6-katalysator-sofortzuender': 'Lichtzünder',
    'v6-katalysator-spiegelung': 'Lichtspiegel',
    'v6-katalysator-umkehrung': 'Lichtkehre',
  ...
  'v6-essenz-schatten': {
    ...
    'v6-katalysator-ausbreitung': 'Schattenspread',
    'v6-katalysator-kettenkopplung': 'Schattenkette',
    'v6-katalysator-verzoegerung': 'Schattenverzögerung',
    'v6-katalysator-sofortzuender': 'Schattenzünder',
    'v6-katalysator-spiegelung': 'Schattenspiegel',
    'v6-katalysator-umkehrung': 'Schattenkehre',
