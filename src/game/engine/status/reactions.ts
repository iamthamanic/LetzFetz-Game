...
export const REACTION_LABEL_DE: Record<ReactionId, string> = {
  inferno: 'Überhitzt',
  ueberflutung: 'Überflutet',
  deep_high: 'Versteinert',
  rueckenwind: 'Tornado',
  erleuchtung: 'Geblendet',
  tiefer_fluch: 'Verdorben',
  dampf: 'Dampf',
  hotbox: 'Schmelze',
  feuersturm: 'Feuersturm',
  sonnenbrand: 'Sonnenbrand',
  hexenbrand: 'Höllenbrand',
  kraeutersud: 'Schlamm',
  wirbel: 'Nebelbank',
  prisma: 'Regenbogen',
  giftbruehe: 'Moder',
  pollenflug: 'Staubsturm',
  growlight: 'Kristallwuchs',
  paranoia: 'Giftsporen',
  blendwerk: 'Blitzlicht',
