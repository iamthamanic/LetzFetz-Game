...
export const V6_PLAY_RULE_SECTIONS: RulesSection[] = [
  ...
  section(
    ...
    [
      ...
      'Fester Passive-Skill pro Charakter (Option B): 1×/eigener Zug, Budget §28 — Info/Filter/Flex, kein Fetz, keine Extra-Aktion. Affinität und Passive-Skill nicht als doppelter ±1-Stack auf dieselbe Aktion (Falsche Farbe erweitert nur Affinität-Eligibilität).',
    ].join('\n'),
  ),
  section(
    'v6-zug',
