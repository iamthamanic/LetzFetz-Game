...
| card-art-pipeline | active | Flux / Higgsfield |
| presentation-vfx | active | Animationen + SFX |
| v2-phrase-playtest | incomplete | Draft Phrase/P100 |

Quellen: `.project-memory/features/*.json` (bilingual).
